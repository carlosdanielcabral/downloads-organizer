...
class MonitoringTab(ctk.CTkFrame):
    ...
    def _setup_status_section(self, processor: FileProcessor) -> None:
        section_label = ctk.CTkLabel(self._container, text="Status", font=("Arial", 14, "bold"))
        section_label.pack(anchor="w", padx=20, pady=(15, 0))

        self._status_section = StatusSection(self._container, processor=processor)
    ...
    def _setup_history_section(self, move_history: MoveHistory) -> None:
        ...
        section_label = ctk.CTkLabel(self._container, text="Histórico", font=("Arial", 14, "bold"))
        section_label.pack(anchor="w", padx=20, pady=(10, 0))

        self._history_section = HistorySection(self._container, move_history=move_history)
